@icon("res://addons/particle_scene_compositor/sync_node_3d/Cpu3d.svg")
...
## is [code]true[/code] if any [CPUParticles3D] node is currently emitting
...
## Starts all child [CPUParticles3D] emissions. Automatically called on [method Node._ready] if autostart is true.
