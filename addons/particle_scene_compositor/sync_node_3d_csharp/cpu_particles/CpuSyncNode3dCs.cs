...
/// <summary>
/// Synchronization hub node that starts and tracks all child <see cref="CpuParticles3D"/>.
/// It will detect any <see cref="CpuParticles3D"/> if it is their ancestor in the tree; they do not need
...
public partial class CpuSyncNode3dCs : Node3D
{
    ...
    /// while no child <see cref="CpuParticles3D"/> are currently emitting.</para>
    /// </summary>
